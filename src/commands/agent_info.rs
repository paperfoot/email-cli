    ...
    let info = json!({
        ...
        "commands": {
            ...
            "audiences_and_contacts": {
                "audience list | ls": "List audiences (deprecated by Resend in favor of segments; still functional)",
                ...
                "contact create | new --audience <id> --email <email>": "Create contact (--first-name, --last-name, --unsubscribed, --properties '{\"k\":\"v\"}')",
