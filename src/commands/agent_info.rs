    ...
    let info = json!({
        ...
        "commands": {
            ...
            "compose": {
                ...
                "draft create | new": "Create local draft (autosave-friendly: recipient/body may be empty; same compose flags as send, including repeatable --reply-to <address>, --reply-to-msg <message_id> for threading, and --scheduled-at <iso>)",
                "draft list | ls": "List drafts (--account)",
                "draft show <id>": "Show draft content",
                "draft edit <id>": "Edit draft while preserving omitted fields (--account/--from, --subject, --text, --html, --clear-html, --to, --cc, --bcc, repeatable --reply-to <address> with an empty value to clear, --scheduled-at <iso>, --clear-schedule, --attach to replace, --clear-attachments). JSON data returns the full updated draft plus updated=true.",
                "draft send <id>": "Send a draft using its persisted Reply-To addresses and schedule",
